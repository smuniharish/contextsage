...
from contextiq.transformation.logs import reduce_log_block
from contextiq.transformation.structured import compact_json

if TYPE_CHECKING:
    from collections.abc import Callable

    from contextiq.budget.tokens import TokenCounter
    from contextiq.core.models import ContextUnit, SummarizationPlan
        ...
        for unit in units:
            ...
            result_units.append(
                replace(
                    ...
                    metadata={**unit.metadata, "contextiq_transformed": True},
                )
            )
