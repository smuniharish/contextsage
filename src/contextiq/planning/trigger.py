...
ContextIQ owns this decision, not the wrapped LangGraph
...
ContextIQ's own token counter and :class:`~contextiq.core.models.BudgetReport`.

When no trigger is supplied, the explicit budget accounting from
:class:`~contextiq.budget.analyzer.BudgetAnalyzer` (available input tokens
