...
:class:`~contextiq.classification.signals.StructuralSignalDetector` classify
each region independently, producing a flat list of
:class:`~contextiq.core.models.ContextUnit` objects.
...
the actual :class:`~contextiq.parsers.code_parser.CodeParser`/
:class:`~contextiq.parsers.json_parser.JSONParser`/
:class:`~contextiq.parsers.log_parser.LogParser` instances found in the
...
from contextiq.core.models import ContentSignals, ContextUnit, RegionKind
from contextiq.parsers.base import ContentParser
from contextiq.parsers.code_parser import DEFAULT_CODE_FENCE_PATTERN, CodeParser
from contextiq.parsers.json_parser import DEFAULT_JSON_START_CHARACTERS, JSONParser
from contextiq.parsers.log_parser import DEFAULT_LOGLEVEL_PATTERN, LogParser
