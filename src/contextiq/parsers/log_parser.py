...
(:mod:`contextiq.parsers.grok_patterns`) — the same vocabulary
...
:mod:`contextiq.transformation.logs`.
...
from contextiq.parsers.grok_patterns import GROK_LOG_LINE, GROK_LOGLEVEL
