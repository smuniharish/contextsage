...
See :mod:`contextiq.parsers` for the design rationale.
"""
...
class ContentParser(ABC):
    ...
    #: The :class:`~contextiq.core.models.RegionKind` (or custom string) this
    ...
    def detect(self, text: str) -> ContentSignals | None:
        ...
        (:class:`~contextiq.classification.signals.StructuralSignalDetector`)
...
def default_registry() -> ParserRegistry:
    """Build the registry ContextIQ uses out of the box.
    ...
    from contextiq.parsers.code_parser import CodeParser  # noqa: PLC0415
    from contextiq.parsers.error_parser import ErrorParser  # noqa: PLC0415
    from contextiq.parsers.json_parser import JSONParser  # noqa: PLC0415
    from contextiq.parsers.log_parser import LogParser  # noqa: PLC0415
    from contextiq.parsers.table_parser import TableParser  # noqa: PLC0415
