...
ContextSage uses ``langgraph-xai`` as a direct dependency for tracking
...
from contextsage.exceptions import ProvenanceError
...
class ProvenanceManager:
    ...
    (e.g. ``PostgresProvenanceStore``) without any change to ContextSage code.
    """

    def __init__(
        self,
        *,
        application_id: str = "contextsage",
